...
(function (factory) {
  ...
  prototype.initPreview = function () {
    ...
    this.$viewBox.html('<sys_images src="' + url + '">');

    // Override sys_images element styles
    ...
    this.$preview.each(function () {
      ...
      $this.data({
        width: $this.width(),
        height: $this.height()
      }).html('<sys_images src="' + url + '" style="display:block;width:100%;min-width:0!important;min-height:0!important;max-width:none!important;max-height:none!important;image-orientation: 0deg!important">');
    });
  };
